...
//    @PostMapping("/login")
    public String login(@Valid @ModelAttribute final LoginForm form,
...
//    @PostMapping("/login")
    public String loginV2(@Valid @ModelAttribute final LoginForm form, final BindingResult bindingResult,
...
//    @PostMapping("/login")
    public String loginV3(@Valid @ModelAttribute final LoginForm form, final BindingResult bindingResult,
